...
def _route_search_core(source_q, dest_q, travel_class="SL", date_str=None) -> dict:
    ...
    client = get_client()
    # Only load stops for stations we might board/alight at (primary + nearby hubs).
    ...
    tracked = 5208  # full network size after production import
            ...
            if nearby:
                ...
                for n in nearby[:2]:
                    ...
                    lines.append(
                        ...
                        f"{alight.get('name') or alight.get('code')} "
